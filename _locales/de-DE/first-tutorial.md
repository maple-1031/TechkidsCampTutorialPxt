...
Verwenden Sie den Block ``||custom:make random background||``, um eine Hintergrundfarbe hinzuzufügen.
...
Fügen Sie Bewegung mit dem ``||controller:Verschieben Sie mySprite mit den Schaltflächen||`` Block.
